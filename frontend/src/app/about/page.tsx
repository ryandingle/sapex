          ...
          <CardContent className="p-6 sm:p-8 space-y-4 text-gray-300">
            <section>
              ...
              <p className="leading-relaxed">
                Sapex is a startup company dedicated to revolutionizing cryptocurrency trading by offering the lowest 
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Why Choose Sapex?</h2>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-3">
                Sapex is built on cutting-edge Web3 technology:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Sapex is built by a passionate team of blockchain developers and crypto enthusiasts who believe in making 
